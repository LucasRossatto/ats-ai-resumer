          ...
          <div className="text-white">
            ...
            >
              ...
              <span
                style={{
                  backgroundImage:
                    "linear-gradient(120deg, #94B5FF 0%, #6B93FF 55%, #5360FF 100%)",
            ...
            >
              <Link
                to="/register"
                className="group relative inline-flex items-center gap-2 h-12 px-5 rounded-full font-semibold text-[14px] text-white shadow-[0_10px_30px_-8px_rgba(83,96,255,0.5)] transition-all hover:shadow-[0_14px_36px_-8px_rgba(83,96,255,0.7)] active:scale-[0.98]"
                style={{
                  background:
