  ...
  return (
    <div className="relative w-full h-[460px] sm:h-[520px]">
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(160deg, #1A1D3D 0%, #16181D 45%, #0F1115 100%)",
          boxShadow:
      ...
      >
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[rgba(107,147,255,0.14)] text-[#6B93FF] text-[10px] font-semibold">
          ...
          <svg viewBox="0 0 200 120" className="w-full h-auto block">
            <defs>
              <linearGradient id="heroArc" x1="0" y1="0" x2="1" y2="0">
                ...
                <stop offset="100%" stopColor="#94B5FF" />
              </linearGradient>
            </defs>
            <path
        ...
        <div className="mt-3 flex items-center justify-center">
          <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-[rgba(107,147,255,0.16)] text-[#94B5FF] text-[10px] font-semibold tabular">
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(155deg, rgba(26,29,61,0.95) 0%, rgba(22,24,29,0.95) 50%, rgba(15,17,21,0.95) 100%)",
          boxShadow:
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="h-6 w-6 rounded-lg bg-[rgba(107,147,255,0.16)] text-[#94B5FF] flex items-center justify-center">
            <Sparkles size={12} />
          </div>
          <div className="text-[11px] font-semibold text-white">AI rewrite</div>
          <div className="ml-auto inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-[rgba(107,147,255,0.16)] text-[#94B5FF] text-[9px] font-semibold">
        ...
        <div className="flex items-center gap-1.5 my-2 text-white/30">
          <ArrowRight size={11} />
          <span className="text-[9px] uppercase tracking-wide text-[#94B5FF] font-semibold">
            After
          </span>
        </div>
