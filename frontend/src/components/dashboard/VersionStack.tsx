  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        isLatest
          ? "bg-[var(--accent)] border-[var(--primary)]/30 shadow-card"
      ...
      {delta != null && (
        <div
          className={cn(
            ...
            delta === 0 && "bg-[var(--card)] text-[var(--muted-foreground)]",
    ...
    <div>
      ...
      <div className="relative h-2.5 rounded-full bg-[var(--muted)] overflow-hidden">
        <motion.div
          ...
          className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-[var(--primary)] to-[var(--primary-strong)]"
        />
        {ticks.map((t) => (
          <div
            key={t.at}
      ...
      <div className="relative h-4 mt-1.5 text-[9px] text-[var(--muted-foreground)] tabular">
          ...
          <div className="space-y-2">
            ...
            <div
              className={cn(
                ...
                totalDelta > 0 && "bg-[var(--accent)] text-[var(--success)]",
                totalDelta < 0 && "bg-[#F8E3E0] text-[var(--destructive)]",
                totalDelta === 0 && "bg-[var(--muted)] text-[var(--muted-foreground)]"
              )}
            >
