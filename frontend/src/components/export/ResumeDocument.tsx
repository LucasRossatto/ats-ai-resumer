...
// Broader/optional than src/types/api.ts ParsedSections — the PDF renderer
// tolerates extra fields (location, description, links, issuer, details)
// that a real backend may send but the current mock data does not.
interface DocLink {
  label?: string;
  url?: string;
}
...
interface DocCertification {
  name?: string;
  issuer?: string;
  year?: number | string;
}
interface DocParsedSections {
  basics?: DocBasics;
  summary?: string;
...
interface ResumeDocumentProps {
  ...
  version?: { parsedSections?: DocParsedSections };
  title?: string;
}

export function ResumeDocument({ user, version, title }: ResumeDocumentProps) {
