      ...
      {({ isActive }) => (
        <div
          className={cn(
            ROW_BASE,
            isActive
              ? "bg-[var(--foreground)] text-[var(--background)] shadow-card"
...
function ActionRow({ icon: Icon, label, onClick, to }: ActionRowProps) {
  ...
  return (
    <aside
      className={cn(
        ...
        "bg-[var(--card)] border border-[var(--border)] shadow-card overflow-hidden",
    ...
    >
      <div className="flex flex-col items-center gap-6 w-full">
        ...
        >
          ...
          <span
            className={cn(
              "ml-2 font-display text-base font-semibold text-[var(--foreground)] whitespace-nowrap",
              "opacity-0 -translate-x-1",
              "transition-[opacity,transform] duration-200 ease-out",
              "group-hover/sidebar:opacity-100 group-hover/sidebar:translate-x-0 group-hover/sidebar:delay-100",
            )}
      ...
      <div className="flex flex-col items-center gap-2 w-full">
        ...
        >
          <div className="h-10 w-10 rounded-full bg-[var(--accent)] text-[var(--primary-strong)] font-semibold flex items-center justify-center text-sm ring-2 ring-[var(--card)] shrink-0">
