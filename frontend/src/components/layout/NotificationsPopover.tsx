...
const ICON_TONE: Record<string, string> = {
  upload: "bg-[var(--muted)] text-[var(--muted-foreground)]",
  analyze: "bg-[var(--accent)] text-[var(--primary-strong)]",
            ...
            <div className="max-h-[420px] overflow-y-auto">
              {events.length === 0 ? (
                <div className="px-5 py-10 text-center">
                  <div className="h-10 w-10 mx-auto rounded-2xl bg-[var(--muted)] flex items-center justify-center text-[var(--muted-foreground)] mb-3">
                    <HistoryIcon size={16} />
                  </div>
                    ...
                    return (
                      <li key={e.id}>
                        <button
                          onClick={() => goTo(e)}
                          className={cn(
                            "w-full flex items-start gap-3 px-5 py-3 text-left hover:bg-[var(--muted)] transition-colors",
